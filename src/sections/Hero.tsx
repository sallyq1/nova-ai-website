...
<h1 className="font-semibold  text-[96px] md:text-[168px] leading-none z-40 gradient-text text-center">Meet Nova</h1>
    <p className=" text-center section-subtext z-40">Enhance your website&aposs visibility with ease using Nova, the cutting-edge AI SEO tool designed to attract new users as efficiently as black holes draw in stars.</p>
